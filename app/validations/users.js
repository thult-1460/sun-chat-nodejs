...
const { checkNameEdit, checkUsernameEdit, checkEmailEdit, checkImgFile, checkPhoneNumber } = require('./actions/profile');
...
exports.validate = (type, app) => {
  switch (type) {
    ...
    case 'update': {
      return [checkNameEdit(), checkUsernameEdit(), checkEmailEdit(), checkImgFile(), checkPhoneNumber()];
    }
  }
};
